    ...
    <section class="page-section my-5 p-5">
        ...
        <form method="POST" action="{{ route('admin.order.update',  $order->id) }}" enctype="multipart/form-data">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input class="form-control" type="number" name="qty" value="{{$order->qty}}">
                </div>
            </div>

            <div class="form-group">
                <label for="description">商品描述</label>
                <textarea class="form-control" type="text" name="description" rows="5">{{$order->description}}</textarea>
            </div>
            ...
            <div class="form-group row">
                ...
                <img src="{{ asset('uploads/order/' . $order->image) }}" class="mt-3" style="height: 100%; width: 100%; object-fit: contain" onerror="this.src='{{ asset('uploads/order/default.jpg') }}'">
            </div>
